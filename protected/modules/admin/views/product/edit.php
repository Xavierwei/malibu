<div class="content">
	...
	<table class="contentTab" width="100%">
		<tr>
			<td class="titleTd" colspan="2">产品管理</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<?php echo CHtml::Button('上传产品',array('id'=>'uploadButton1','class'=>'uploadButton'));?>
		...
		<tr>
			...
			<td>
				<?php echo CHtml::Button('上传产品',array('id'=>'uploadButton2','class'=>'uploadButton','dir'=>'image','catalogue'=>'product'));?>
		...
		<tr>
			<td class="leftTd" width="100"><?php echo $form->labelEx($model,'market_price'); ?></td>
			<td>
				<?php echo $form->textField($model,'market_price',array('value'=>$model->market_price,'class'=>'commonText'));?>
				<?php echo $form->error($model,'market_price'); ?>
			</td>
		</tr>
		<tr>
			<td class="leftTd" width="100"><?php echo $form->labelEx($model,'price'); ?></td>
			<td>
				<?php echo $form->textField($model,'price',array('value'=>$model->price,'class'=>'commonText'));?>
