<div class="content">
	...
	<table class="contentTab listTab" width="100%">
		...
		<tr>
			...
			<th><?php echo $form->labelEx($model,'market_price');?></th>
		...
		<?php foreach($data as $key=>$item){ ?>
			<tr>
				...
				<td><?php echo '<span class="throughLine"><a class="throughText">'.$item->market_price.'</a></span>';?></td>
				...
				<?php $recommend = $item->recommend==1?'<img src="'.yii::app()->baseUrl.'/style/admin/images/audit.gif">':'<img src="/style/admin/images/unaudit.gif">';?>
