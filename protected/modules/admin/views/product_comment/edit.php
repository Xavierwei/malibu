<div class="content">
	...
	<table class="contentTab" width="100%">
		<tr>
			<td class="titleTd" colspan="2">产品评论</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="leftTd" width="100"><?php echo $form->labelEx($model,'product_id'); ?></td>
			<td>
				<?php echo isset($model->product->title)?$model->product->title:'';?>
			</td>
		</tr>
		<tr>
