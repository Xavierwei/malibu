<div class="content">
	...
	<table class="contentTab" width="100%">
		...
		<tr>
			...
			<td>
				<?php echo CHtml::image($model->photo1!=''?yii::app()->baseUrl.$model->photo1:yii::app()->baseUrl.'/style/admin/images/noPhoto.png',$model->username,array('id'=>'photoPreview1','class'=>'photoPreview','height'=>'50px'));?>
