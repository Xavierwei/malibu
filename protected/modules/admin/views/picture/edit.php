<div class="content">
	...
	<table class="contentTab" width="100%">
		<tr>
			<td class="titleTd" colspan="2">图片管理</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="leftTd"><?php echo $form->labelEx($model,'type_id'); ?></td>
			<td>
				<?php echo $form->dropDownList($model,'type_id',Type::model()->getTypeList('0','请选择'),array('class'=>'select')); ?>
			...
			<td>
				...
				<?php
			        $this->widget('ext.kindeditor.KindUploadWidget',array(
			            ...
			            'delete'=>'photoDelete1',
			            'callback_url'=>Yii::app()->createUrl('/admin/picture/photoSave'),
		...
		<tr>
			...
			<td>
				...
				<?php echo CHtml::ajaxLink(
			        '删除', 
			        array('/admin/picture/photoDelete'),
			        array(
		...
		<tr>
			...
			<td>
				<?php echo CHtml::Button('上传图片',array('id'=>'uploadButton2','class'=>'uploadButton','dir'=>'image','catalogue'=>'picture'));?>
		...
		<tr>
			...
			<td>
				...
				$this->widget('ext.kindeditor.KindEditorWidget',array(
					'id'=>'Picture_content',
					'items' => array(
						'uploadJson'=>Yii::app()->assetManager->publish(Yii::getPathOfAlias('ext.kindeditor.assets')).'/php/upload_json.php?root='.yii::app()->baseUrl.'&catalogue=picture_content',
						'width'=>'670px',
						'height'=>'200px',
