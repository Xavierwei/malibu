<div class="content">
	...
	<table class="contentTab" width="100%">
		<tr>
			<td class="titleTd" colspan="2">单页管理</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<?php echo $form->dropDownList($model,'parent',Leaf::model()->getLeafList('0','主栏目'),array("class"=>'select')); ?>
		...
		<tr>
			...
			<td>
				...
				$this->widget('ext.kindeditor.KindEditorWidget',array(
					'id'=>'Leaf_content',
					'items' => array(
						'uploadJson'=>Yii::app()->assetManager->publish(Yii::getPathOfAlias('ext.kindeditor.assets')).'/php/upload_json.php?root='.yii::app()->baseUrl.'&catalogue=leaf_content',
						'width'=>'670px',
						'height'=>'200px',
