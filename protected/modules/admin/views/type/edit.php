<div class="content">
	...
	<table class="contentTab" width="100%">
		...
		<tr>
			...
			<td>
				<?php echo $form->dropDownList($model,'parent',Type::model()->getTypeList('0','主分类'),array("class"=>'select')); ?>
		...
		<tr>
			...
			<td>
				...
				$this->widget('ext.kindeditor.KindEditorWidget',array(
					'id'=>'Type_content',
					'items' => array(
						'uploadJson'=>Yii::app()->assetManager->publish(Yii::getPathOfAlias('ext.kindeditor.assets')).'/php/upload_json.php?root='.yii::app()->baseUrl.'&catalogue=type_content',
						'width'=>'670px',
						'height'=>'200px',
